import { isIP, compile, all, proxyaddr } from '../../deps.ts'
import { THRequest } from '../../request.ts'
import { Protocol } from '../../types.ts'

export const trustRemoteAddress = <Request extends THRequest = THRequest>(req: Request) => {
...
export const getHostname = <Request extends THRequest = THRequest>(req: Request): string | undefined => {
